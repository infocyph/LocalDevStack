...
assert_contains "$help_output" "convert [--force] <input> <output>"
assert_contains "$markdown_output" "lds convert [--force] <input> <output>"
assert_contains "$markdown_output" "lds convert --list-input-formats"
