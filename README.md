...
Provider configuration placed in `docker/.env` is forwarded to `llm-sm` where applicable:
...
| `LLM_SM_INPUT_WARN_BYTES` | `1048576` | Text/diff warning threshold |
