...
# Internal implementation plans are repository artifacts, not public Sphinx pages.
...
html_theme_options = {
    "repository_url": "https://github.com/infocyph/LocalDevStack",
...
html_title       = f"LocalDevStack – {version} Documentation"
